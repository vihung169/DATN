    ...
    <div class="page">
        ...
        <section>
            <div class="container-fluid">
                <!-- Page Header-->
                <header>
                    <h1 class="h3 display">Biểu đồ ngày: <?php echo $row["curngay"] ?></h1>
                </header>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
                                            $st = "SELECT * FROM weather WHERE username='$username' AND DATE_SUB(CURDATE(),INTERVAL 01 DAY) <= curngay ORDER BY id DESC";
